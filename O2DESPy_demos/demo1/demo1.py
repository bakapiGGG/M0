...
class HelloWorld(Sandbox):
    ...
    def arrive(self):
        ...
        self.count += 1
        self.schedule(self.arrive, datetime.timedelta(hours=round(random.expovariate(1 / self.hourly_arrival_rate))))


if __name__ == '__main__':
    # Demo 1
    sim1 = HelloWorld(1, seed=1)
    sim1.warmup(till=datetime.datetime(year=1, month=1, day=2, hour=0, minute=0, second=0))
